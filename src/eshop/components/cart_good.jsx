    ...
    <div className="grid lg:grid-col-3  sm:grid-col-1">
      ...
      <div className="lg:col-end-3 rounded-md bg-slate-700 text-white">
        ...
        <div className="grid grid-cols-2 gap-3 m-3 items-center ">
          <span className="text-yellow-300 border rounded-md block border-yellow-300">${props.price}</span>
          <button className="text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm p-2" onClick={handleRemove(props.id)}>
            Remove from Cart
          </button>
        </div>
      </div>
